...
export const ManufacturerDetailPage = () => {
  ...
  return (
    <div className="space-y-4">
      <Link to="/manufacturers" className="text-sm text-text-muted">← Back to manufacturers</Link>
      <h1 className="text-3xl">{manufacturer.name}</h1>
      <p className="text-text-muted">{manufacturer.country} · Founded {manufacturer.founded} · {manufacturer.yearsActive}</p>
      <p className="text-text-primary">{manufacturer.overview}</p>
